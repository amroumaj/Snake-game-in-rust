...
#[allow(dead_code)]
pub const RUSTC: &str = r"/home/amrou/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/home/amrou/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[doc=r#"The output of `/home/amrou/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.79.0 (129f3b996 2024-06-10)";
#[doc=r#"The output of `/home/amrou/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/amrou/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
